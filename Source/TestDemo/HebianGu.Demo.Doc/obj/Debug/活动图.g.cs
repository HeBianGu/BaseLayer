...
namespace HebianGu.Demo.Doc.流程图 {
    ...
    public partial class 活动图 : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(活动图).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(活动图));
        ...
        private string FindResource() {
            string[] resources = typeof(活动图).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".活动图.g.xaml") || resource.Equals("活动图.g.xaml"))) {
                    return resource;
                }
            }
