...
namespace OPT.Product.Modules.SimON.SimONDataCenter
{
    /// <summary> 枚举转换器 用此类之前，必须保证在枚举项中定义了Description </summary>
    public class EnumConverterEx : TypeConverter// ExpandableObjectConverter
    {
