...
namespace HebianGu.ComLibModule.SocketHelper
{
    internal class FileMustBase : IFileMustBase
    {
        ...
        {
            EngineTool.EventInvoket(() => { this.fileMustBase.FileCancel(FileLabel); });
        }
        /// <summary>
        ...
        {
            EngineTool.EventInvoket(() => { this.fileMustBase.FileFailure(FileLabel); });
        }
        /// <summary>
        ...
        {
            EngineTool.EventInvoket(() => { this.fileMustBase.FileContinue(FileLabel); });
        }
        /// <summary>
