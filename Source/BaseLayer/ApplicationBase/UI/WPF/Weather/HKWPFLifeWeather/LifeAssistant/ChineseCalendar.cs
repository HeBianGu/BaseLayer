...
#region 内部结构
        ...
        private struct ChineseHolidayStruct
        {
            public int Month;
            public int Day;
            public int Recess;
            ...
            public ChineseHolidayStruct(int month, int day, int recess, string name)
            {
                Month = month;
                Day = day;
                Recess = recess;
        ...
        ///</remarks>
        private static int[] ChineseDateArray = new int[]{
        ...
        #region 二十四节气
        private static string[] _ChineseHolidayName = 
                    { 
                    "小寒", "大寒", "立春", "雨水", 
                    "惊蛰", "春分", "清明", "谷雨", 
                    "立夏", "小满", "芒种", "夏至", 
        ...
        #region 按农历计算的节日
        private static ChineseHolidayStruct[] lHolidayInfo = new ChineseHolidayStruct[]{
            new ChineseHolidayStruct(1, 1, 1, "春节"), 
            new ChineseHolidayStruct(1, 15, 0, "元宵节"), 
            new ChineseHolidayStruct(5, 5, 0, "端午节"), 
            new ChineseHolidayStruct(7, 7, 0, "七夕情人节"),
            new ChineseHolidayStruct(7, 15, 0, "中元节 盂兰盆节"), 
            new ChineseHolidayStruct(8, 15, 0, "中秋节"), 
            new ChineseHolidayStruct(9, 9, 0, "重阳节"), 
            new ChineseHolidayStruct(12, 8, 0, "腊八节"),
            new ChineseHolidayStruct(12, 23, 0, "北方小年(扫房)"),
            new ChineseHolidayStruct(12, 24, 0, "南方小年(掸尘)"),
            //new ChineseHolidayStruct(12, 30, 0, "除夕")  //注意除夕需要其它方法进行计算
        };
        #endregion
        ...
        {   //0X0FFFF[0000 {1111 1111 1111} 1111]
            if (BitTest32((ChineseDateArray[year - MinYear] & 0x0000FFFF), (16 - month)))
            {
                return 30;
            }
            else
        ...
        private int GetChineseLeapMonth(int year)
        {
            ...
            return ChineseDateArray[year - MinYear] & 0xF;
        ...
        private int GetChineseLeapMonthDays(int year)
        {
            if (GetChineseLeapMonth(year) != 0)
            {
                ...
                if ((ChineseDateArray[year - MinYear] & 0x10000) != 0)
                {   //为1则润大月
                    return 30;
                }
                else
        ...
        private int GetChineseYearDays(int year)
        {
            ...
            i = 0x8000;
            info = ChineseDateArray[year - MinYear] & 0x0FFFF;
        ...
        public string ChineseCalendarHoliday
        {
            get
            {
                ...
                {
                    foreach (ChineseHolidayStruct lh in lHolidayInfo)
                    {
        ...
        #region ChineseShortDateString
        /// <summary>
        /// 取农历日期表示法：初五
        /// </summary>
        public string ChineseShortDateString
        {
            get
            {
