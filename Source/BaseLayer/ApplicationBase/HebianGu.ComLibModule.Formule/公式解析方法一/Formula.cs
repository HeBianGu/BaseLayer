...
namespace HebianGu.ComLibModule.Formule
{
    ...
    /// <summary> 运算符类型枚举  运算符类型(从上到下优先级依次递减)，数值越大，优先级越低  </summary>
    ...
    /// <summary> RPN类 变量和属性 逆波兰式  </summary>
    public class Formula
    {
        Stack<object> m_tokens = new Stack<object>();            //最终逆波兰式堆栈
        /// <summary>  最终逆波兰式堆栈  </summary>
