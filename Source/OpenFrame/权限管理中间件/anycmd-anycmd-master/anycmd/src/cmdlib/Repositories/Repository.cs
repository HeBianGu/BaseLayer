...
namespace Anycmd.Repositories
{
    ...
    public abstract class Repository<TAggregateRoot, TAggregateRootId> : IRepository<TAggregateRoot, TAggregateRootId>
        where TAggregateRoot : class, IAggregateRoot<TAggregateRootId>
    {
        ...
        protected abstract TAggregateRoot DoGetByKey(TAggregateRootId key);
