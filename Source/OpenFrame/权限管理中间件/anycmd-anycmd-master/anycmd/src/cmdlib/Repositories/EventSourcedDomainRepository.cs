...
namespace Anycmd.Repositories
{
    ...
    public class EventSourcedDomainRepository<TAggregateRootId> : EventPublisherDomainRepository<TAggregateRootId>
    {
        ...
        /// </summary>
        /// <param name="domainEventStorage">The <see cref="Anycmd.Events.Storage.IDomainEventStorage{T}"/> instance
        ...
        /// are published.</param>
        /// <param name="snapshotProvider">The <see cref="Anycmd.Snapshots.Providers.ISnapshotProvider{T}"/> instance
        ...
        /// <summary>
        /// Gets the <see cref="Anycmd.Snapshots.Providers.ISnapshotProvider{T}"/> instance
