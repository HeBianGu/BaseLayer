...
//		[DllImport(LIBRARY_GLU)] private static extern void  gluTessCallback(IntPtr tess, int which, SharpGL.Delegates.Tesselators.VertexData callback);
        ...
        {
            PreGLCall();
            glDrawElements(mode, count, OpenGL.GL_UNSIGNED_INT, indices);
            PostGLCall();
        }
...
if (insideGLBegin == false)
{
        ...
        protected virtual void PostGLCall()
        {
            ...
            if (insideGLBegin == false)
            {
                ...
                if (errorCode != OpenGL.GL_NO_ERROR)
                {
                    ...
                    string functionName = stackFrames.Length > 1 ? stackFrames[1].GetMethod().Name : "Unknown Function";
                    System.Diagnostics.Trace.WriteLine("OpenGL Error: \"" + errorMessage + "\", when calling function SharpGL." + functionName);
                }
            }
#endif
        }
    ...
    public virtual void MakeNothingCurrent()
    {
      Win32.wglMakeCurrent(IntPtr.Zero, IntPtr.Zero);
        ...
        /// </summary>
        private static OpenGL currentOpenGLInstance = null;

        /// <summary>
        /// The render context provider.
        /// </summary>
        private IRenderContextProvider renderContextProvider = null;

        /// <summary>
        /// Set to true if we're inside glBegin.
        /// </summary>
        private bool insideGLBegin = false;

        /// <summary>
        /// The fontbitmaps object is used to allow easy rendering of text.
        /// </summary>
        private FontBitmaps fontBitmaps = new FontBitmaps();

        /// <summary>
        /// The FontOutlines object is used to allow rendering of text.
        /// </summary>
        private FontOutlines fontOutlines = new FontOutlines();
